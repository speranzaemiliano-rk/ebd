/* ==========================================================================
   NAIIB — Nomenclador de Actividades de Ingresos Brutos

   Qué es: la lista oficial de actividades económicas de ARBA. Cada actividad
   tiene un código de seis dígitos y un nombre. Es el mismo código que pide
   AGIP con el nombre NAES, así que sirve para las dos jurisdicciones.

   Para qué lo usa el sistema:
   - en la ficha del cliente, al escribir el código aparece el nombre oficial,
     y se puede buscar el código escribiendo la actividad;
   - en la tabla de Alícuotas IIBB, completa el nombre de las actividades que
     el anexo trae sólo con código y porcentaje.

   OJO: acá NO hay ni un porcentaje. Las alícuotas las fija la Ley Impositiva
   de cada año y se cargan aparte, en la pantalla «Alícuotas IIBB».

   De dónde salió: https://www.arba.gov.ar/archivos/Publicaciones/naiib.html
   Bajado en septiembre de 2026. 1019 actividades.

   Para actualizarlo cuando ARBA publique una versión nueva: se rearma este
   archivo desde esa página (una fila de la tabla por renglón de acá). Las
   columnas «Incluye» y «Excluye» no se copian porque pesan diez veces más
   que el resto; para eso el sistema linkea al renglón en el sitio de ARBA.
   ========================================================================== */
...
"012602":"Cultivos de frutos oleaginosos para su procesamiento industrial posterior",
...
"101042":"Matanza de ganado, excepto el bovino y porcino, y rocesamiento de su carne.",
...
"109001":"Servicios industriales para la elaboración de alimentos obtenido de ganado bovino",
"109002":"Servicios industriales para la elaboración bebidas alcohólicas",
...
"192002":"Refinación del petróleo -Ley Nacional N° 23966-",
...
"352022":"Distribución de gas natural -Ley Nacional N° 23966 -",
...
"452910":"Instalación y reparación de equipos de G.N.C.",
...
"461018":"Cooperativas -ART 188 inc.g) y h) DEL CODIGO FISCAL T.O.2011-",
...
"473003":"Venta al por menor de combustibles n.c.p. comprendidos en la Ley N° 23966 para vehículos automotores y motocicletas",
...
"477311":"Venta al por menor de productos farmacéuticos y de herboristería",
...
"477461":"Venta al por menor de combustibles comprendidos en la ley 23.966, excepto de producción propia y excepto para automotores y motocicletas",
"477462":"Venta al por menor de combustible de producción propia comprendidos en la ley 23.966 excepto para vehículos automotores y motocicletas",
...
"641931":"SERVICIOS DE LA BANCA MINORISTA, EXCEPTO LOS CORRESPONDIENTES A LOS INTERESES AJUSTES DE CAPITAL DE LOS PRESTAMOS HIPOTECARIOS OTORGADOS A PERSONAS FISICAS, CON DESTINO A LA COMPRA, CONSTRUCCION, AMPLIACION O REFACCION DE VIVIENDA UNICA, FAMILIAR Y DE OCUPACION PERMANENTE.",
"641932":"SERVICIOS DE LA BANCA MINORISTA CORRESPONDIENTE A LOS INTERESES Y AJUSTES DE CAPITAL DE LOS PRESTAMOS HIPOTECARIOS OTORGADOS A PERSONAS FISICAS CON DESTINO A LA COMPRA, CONSTRUCCION, AMPLIACION O REFACCION DE VIVIENDA UNICA FAMILIAR Y DE OCUPACION PERMANENTE.",
...
"641944":"SERVICIOS DE LAS ENTIDADES FINANCIERAS NO BANCARIAS, EXCEPTO LOS CORRESPONDIENTES A LOS INTERESES Y AJUSTES DE CAPITAL DE LOS PRESTAMOS HIPOTECARIOS OTORGADOS A PERSONAS FISICAS CON DESTINO A LA COMPRA, CONSTRUCCION, AMPLIACION O REFACCION DE VIVIENDA UNICA, FAMILIAR Y DE OCUPACION PERMANENTE.",
"641949":"SERVICIOS DE LAS ENTIDADES FINANCIERAS NO BANCARIAS CORRESPONDIENTES A LOS INTERESES Y AJUSTES DE CAPITAL DE LOS PRESTAMOS HIPOTECARIOS OTORGADOS A PERSONAS FISICAS CON DESTINO A LA COMPRA, CONSTRUCCION, AMPLIACION O REFACCION DE VIVIENDA UNICA, FAMILIAR Y DE OCUPACION PERMANENTE.",
